...
const CopyableCode = ({ children }) => {
  ...
  const handleCodeClick = () => {
    ...
    toast.custom(() => (
    <div style={{ border: '1px solid #9EB1FF', padding: '10px', borderRadius: '5px', display: 'flex', alignItems: 'center' }}>
  ...
  return (
    ...
    >
      <code style={{ 
        backgroundColor: isHovered ? '#9EB1FF' : 'transparent', 
        padding: '1px 4px',
        fontFamily: 'monospace', 
        borderRadius: '4px',
        border: '1px solid #9EB1FF',
        fontSize: '0.82rem',
        color: isHovered ? '#000' : '#9EB1FF'
      }}>
        {children}
      </code>
    </span>
